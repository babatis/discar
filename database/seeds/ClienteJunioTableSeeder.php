...
class ClienteJunioTableSeeder extends Seeder
{
    /**
    ...
    {
        /**
        * INGRESO DE CLIENTES MES Junio 2019
        */
        ...
        foreach ($dcliente as $value) {
            ...
            else 
            {
                ...
                $ciudad = $PROVINCIA->select()->where('PROVINCIA_NOMBRE', $value->CiudadRecep)->first();
                $comuna = $COMUNA->select()->where('COMUNA_NOMBRE', $value->CmnaRecep)->first() ;
