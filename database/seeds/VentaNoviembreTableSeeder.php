...
class VentaNoviembreTableSeeder extends Seeder
{   
    ...
    public function run()
    {
        $path = public_path() . '/storage/xml/DTE_76944108_33_NOVIEMBRE.xml';
            ...
            foreach ($SetDTE as $dte) {
                ...
                if ($dte->Documento->Encabezado->IdDoc->Folio == $exam->Folio) {
                    ...
                    foreach ($dte->Documento->Detalle as  $value) {
                        ...
                        $prod_id = $prod->where('codinterno', (string) $pd_id)->first();
                        ...
                        if (is_null($prod_id)) {
                            ...
                            // $prod_id->cantidad  = $prod_id->cantidad - $value->QtyItem;
                            // $prod_id->save();
                        }   
